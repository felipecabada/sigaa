...
CREATE TABLE `usuario_programa` (
  ...
  PRIMARY KEY (`id`),
  KEY `RF_capacitacion_usuario_idx` (`id_usuario`),
  CONSTRAINT `RF_capacitacion_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
